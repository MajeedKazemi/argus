...
import WSRegionsPlugin from 'wavesurfer.js/src/plugin/regions';
import WSMinimapPlugin from 'wavesurfer.js/src/plugin/minimap';
import WSTimelinePlugin from 'wavesurfer.js/src/plugin/timeline';
import WSCursorPlugin from 'wavesurfer.js/src/plugin/cursor';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    wavesurfer = WaveSurfer.create({
        ...
        plugins: [
            ...
            WSMinimapPlugin.create({
                height: 30,
                waveColor: '#ddd',
                progressColor: '#999'
            }),
            WSTimelinePlugin.create({
    ...
    var mediaElt = document.getElementById('video');
